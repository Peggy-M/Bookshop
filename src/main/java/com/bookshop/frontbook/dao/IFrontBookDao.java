	package com.bookshop.frontbook.dao;
...
public interface IFrontBookDao {
	/**
	 * 通过id查书
	 * 
	 * @param id
	 ...
	 * @return
	 */
	Integer getbookcount(Integer status);
	 ...
	 * @return
	 */
	List<BookBean> getBookByBookTypeThird(Integer typeNo,Integer pageNo);
	 ...
	 * @return
	 */
	List<BookBean> getBookByBookTypeSecond(Integer typeNo,Integer pageNo);
	 ...
	 * @return
	 */
	List<BookBean> getBookByBookTypeFirst(Integer typeNo,Integer pageNo);
