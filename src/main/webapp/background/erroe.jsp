...
<div class="box">
    <br/>
    <h1 class="text-center text-white" style="margin-top: 200px;"><span class="glyphicon glyphicon-leaf"></span>&nbsp;&nbsp;您当前没有此权限，请联系管理员</h1>
    <a title="点击返回上一页">
		<div class="link"  onclick="javascript:history.back()"></div>
	</a>
    </div>
