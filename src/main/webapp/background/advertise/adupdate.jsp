        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                ...
                <!-- NOTE: To use the contact form, your site must be on a live web host with PHP! The form will not work locally! -->
                    <form action="<%=basePath%>/advertise/update.do?id=${advertise.adId}" method="post" id="contentForm">
			    		<div class="input-group">
						  <span class="input-group-addon" id="basic-addon1">公告标题:</span>
						  <input id="adTitle" name="adTitle" value="${advertise.adTitle}" type="text" class="form-control" placeholder="标题" aria-describedby="basic-addon1" maxlength="40" >
						</div>
						  <p id="mes" style="color:red;font-size: 12px" ></p>
						<br/>
			    		<textarea id="adContent" name="adContent" rows="40" class="col-sm-12">${advertise.adContent}</textarea>
