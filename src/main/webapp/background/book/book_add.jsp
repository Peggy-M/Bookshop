	    ...
	    <div class="col-lg-8">
	    	<div class="panel panel-info">
				...
				<div class="panel-body">
					<form class="form-horizontal" enctype="multipart/form-data" id="book_save_form" action="<%=basePath %>/book/saveBook" method="post">
				              ...
				              <ul>
				                  ...
				                  <li>
					                  <div class="form-group top2">
					                      ...
					                      <div class="col-sm-10">
					                      	<input name="bookAuthor" type="text" id="bookAuthor"/>
					                      </div>
					                  </div>
				                  </li>
				                  <li>
					                  <div class="form-group top2">
					                      ...
					                      <div class="col-sm-10">
						                      ...
						                      <a href="#" class=" btn btn-primary " data-toggle="modal" data-target="#details1">图书详情添加</a>
						                       <!-- <textarea id="bookdetails1" name="bookdetails" rows="40" class="col-sm-12"></textarea> -->
						                       <input type="hidden" id="bookdetails" name="bookdetails">
					                       </div>
					                    </div>
				                   </li>
				                    <li>
					                    <div class="form-group top2">
					                        ...
					                        <div class="col-sm-10">
					                        	<input name="bookPress" type="text" id="bookPress"/>
					                        </div>
					                    </div>
				                    </li>
				                    <li>
					                    <div class="form-group top2">
					                        ...
					                        <div class="col-sm-10">
					                        	<input name="bookPblishTime" type="text" id="bookPblishTime"/>
					                        </div>
					                    </div>
				                    </li>
				                    <li>
					                    <div class="form-group top2">
					                        ...
					                        <div class="col-sm-10">
					                        	<input name="bookEdition" type="text" id="bookEdition"/>
					                        </div>
					                    </div>
				                    </li>
				                    <li>
					                    <div class="form-group top2">
					                        ...
					                        <div class="col-sm-10">
					                        	<input name="bookSize" type="text" id="bookSize"/>
					                        </div>
					                    </div>
				                    </li>
				                    <li>
					                    <div class="form-group top2">
					                        ...
					                        <div class="col-sm-10">
					                        	<input name="bookPrice"  type="text" id="bookPrice"/>
				                    ...
				                    <li>
					                    <div class="form-group top2">
					                        ...
					                        <div class="col-sm-10">
					                        	<input name="bookSellPrice" type="text" id="bookSellPrice"/>
					                        	<span id="helpBlock" class="help-block">请输入非0正整数，单位是：分</span>
					                        </div>
					                    </div>
				                    </li>
				                    <li>
					                    <div class="form-group top2">
					                        ...
					                        <div class="col-sm-10">
					                        	<input name="bookPrimeCost" type="text" id="bookPrimeCost"/>
					                        	<span id="helpBlock" class="help-block">请输入非0正整数，单位是：分</span>
					                        </div>
					                    </div>
				                    </li>
				                    <li>
					                 ...
					                 <li>
						                 <div class="form-group top2">
						                    ...
						                    <div class="col-sm-10">
												...
												<input name="bookTypeSecond" type="hidden" id="bookTypeSecond">
											</div>
										</div>
					                 </li>
					                 <li>
						                 <div class="form-group top2">
						                    ...
						                    <div class="col-sm-10">
						                                                <!-- <input name="bookTypeThird" type="text"/> -->
					                 ...
					                 <li>
						                 <div class="form-group top2">
						                    ...
						                    <div class="col-sm-10">
						                    	<input name="bookNumber" type="text" id="bookNumber"/>
					                 ...
					                 <li>
						                 <div class="form-group top2">
						                	...
						                	<div class="col-sm-10" id="status_radio">
						                		<input name="bookStatus" type="radio" checked="checked" value="0" id="status0_label"/>
					               	...
					               	<li>
						               	<div class="form-group top2">
						                	...
						                	<div class="col-sm-10">
						                    	<input name="bookSales" type="text" id="bookSales"/>
						                    	<span id="helpBlock" class="help-block">请输入正整数，单位是：本</span>
						                    </div>
						                </div>
					            	</li>
						...
						<div class="modal fade" id="details1" tabindex="-1" role="dialog" aria-labelledby="details11">
					         <div class="modal-dialog" role="document">
					             <div class="modal-content">
									...
									<textarea id="book_details" name="bookdetails1" rows="40" class="col-sm-12"></textarea>
					                  </div>
		    									...
		    									if(null!=bookPriceVal&&bookPriceVal!=""&&bookPriceVal.match(/^\+?[1-9][0-9]*$/)){
		    										if(null!=bookSellPriceVal&&bookSellPriceVal!=""&&bookPriceVal.match(/^\+?[1-9][0-9]*$/)){
		    											if(null!=bookPrimeCostVal&&bookPrimeCostVal!=""&&bookPriceVal.match(/^\+?[1-9][0-9]*$/)){
		    												if(null!=bookTyprFirstVal&&bookTyprFirstVal!=""){
		    													if(null!=bookTypeSecondVal&&bookTypeSecondVal!=""){
		    														if(null!=bookTypeThirdVal&&bookTypeThirdVal!=""){
