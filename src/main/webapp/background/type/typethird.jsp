...
<table class="table table-bordered table-striped text-center bg-info">
                ...
                <div class="input-group line left">
                    ...
                    <input name="typeSecondId" id="typeSecondId" type="text" class="form-control" placeholder="输入二级类目ID搜索" aria-describedby="basic-addon2">
                </div>
                <a onclick="query(typeSecondId)" class=" btn btn-primary "><span class="glyphicon glyphicon-search"></span></a>
	...
	<thead>
      <tr class="info">
         ...
         <th class="text-center">二级类目ID</th>
         <th class="text-center">操作</th>
      </tr>
    </thead>
    <tbody>
      <c:forEach items="${thirdTypeList}" var="thirdType">
      <tr>
...
//根据一级类目ID查询所有当前二级类目
function query(typeSecondId){
	var typeSecondId = $("#typeSecondId").val();
	window.location.href="<%=basePath%>/type3/thirdtype.do?typeSecondId="+typeSecondId;
}
