...
<table class="table table-bordered table-striped text-center bg-info">
                ...
                <div class="input-group line left">
                    ...
                    <input name="typeFirstId" id="typeFirstId" type="text" class="form-control" placeholder="输入一级类目ID搜索" aria-describedby="basic-addon2">
                </div>
	...
	<thead>
      <tr class="info">
         ...
         <th class="text-center">一级类目ID</th>
         <th class="text-center">操作</th>
      </tr>
    </thead>
    <tbody>
      <c:forEach items="${secondTypeList}" var="secondType">
      <tr>
...
//根据一级类目ID查询所有当前二级类目
function query(typeFirstId){
	var typeFirstId = $("#typeFirstId").val();
	window.location.href="<%=basePath%>/type2/secondtype.do?typeFirstId="+typeFirstId;
}
//获取要编辑的二级类目名及上级类目Id
