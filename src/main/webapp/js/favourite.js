var currMid=0;var currPid=0;var imgPath=frontPath+"/images/loadingAnimation.gif";var categoryLink=frontPath+"/Favourite/AddFavLayer.do";var h="220";var w="344";function addFavor(mid,pid,height,width){currMid=mid;currPid=pid;var evt=getEvent();var element=evt.target||evt.srcElement;var objH=height==null||height==""?h:height;var objW=width==null||width==""?w:width;var layer=document.getElementById("tb_layer");if(layer!=null){document.body.removeChild(layer);createLayer(objH,objW,element);}else{createLayer(objH,objW,element);}
return true;}
function addFavor(mid,pid,height,width,isReadtype){currMid=mid;currPid=pid;var evt=getEvent();var element=evt.target||evt.srcElement;var objH=height==null||height==""?h:height;var objW=width==null||width==""?w:width;var layer=document.getElementById("tb_layer");if(isReadtype){categoryLink=frontPath+"/Favourite/AddBookSelf.do";}else{categoryLink=frontPath+"/Favourite/AddFavLayer.do"}
