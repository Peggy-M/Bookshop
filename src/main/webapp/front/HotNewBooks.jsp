...
<div class="list" style="display:none">
	<c:forEach var="type2andtype1" items="${type2aboutType1Beanlist}">
		...
		<ul>
		  ...
		  <li class="cur"><a href="<%=basePath%>/frontbook/HotNewBooks?status=2&pageSize=10&pageNo=1" class="current">新书精选</a></li>
...
<div class="product contain">
	...
	<div>
        ...
        <!--end 浏览历史-->
        <div class="adv1">
		  <div class="" name="bannerPic">
		  		<a href="#"></a>
		  		<a href="#" target="_blank">
		  			<img src="<%=basePath %>/img/2014012810184177.jpg" width="192" height="286" alt=" 从你的全世界路过" border="0">
		  		</a>
		  </div>
		</div>
		</div>
		...
		<div class="rightCon">
			<h3 class="h4"><strong>文学类新书推荐</strong><span>TOP500</span>&nbsp;<em style="color:#2a6ed3;font-size:12px;">每页显示10个商品(每日更新)</em></h3>
			<c:forEach var="book" items="${books}">
			<ul class="list">
        		<li>
					<div class="li-img fl">
						<a target="_blank" href="<%=basePath%>/frontbook/Product?id=${book.bookId}" title=""><img src="<%=basePath %>${book.bookCover}" alt="${book.bookName}" title="${book.bookName}"></a>
					</div>
					<div class="li-con fl">
					<h2><a target="_blank" href="<%=basePath%>/frontbook/Product?id=${book.bookId}"><strong>${book.bookName}</strong></a></h2>
					<dl>
						<dt>
							<div class="line_1">
    							<div class="marketPrice"><span class="priceName">定价：</span><span class="priceValue">${book.bookPrice/100}</span></div>
    							<!-- added by alex 用于抢购来计算折扣 -->
    							<div class="memberPrice"><span class="priceName">广购价：</span><span class="priceValue">${book.bookSellPrice/100}</span></div>
						...
						<dd>
							<form method="post" action="#" style="margin:0;" id="buyForm" onsubmit="return false;">
	    						<div class="btn">
					                <input type="hidden" name="reqUrl" value="/HotNewBooks.do?columnid=66230">
					                <input type="hidden" id="bookId" name="bookId" value="${book.bookId}">
					                <input type="hidden" name="merId" value="0">
					                <input type="image" src="<%=basePath %>/img/book_search_list.png" alt="" onclick="buyNow(${book.bookId})">
	        						<%-- <a onclick="_gaq.push([&#39;_trackEvent&#39;, &#39;click&#39;,&#39;收藏键&#39;, &#39;新书页&gt;收藏该图书&#39;]);addFavor(&#39;0&#39;,&#39;4061155&#39;,&#39;&#39;,&#39;&#39;,false)" href="javascript:;" class="collec"><img src="<%=basePath %>/img/book_search_list1.png" alt=""></a> --%>
	    						</div>
							</form>
						</dd>
					</dl>
