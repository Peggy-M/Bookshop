...
<body id="body" style="width: 100%;">
	...
	<div class="header">
		...
		<div class="bottom contain">
			...
			<h1>
				<a href='<%=basePath%>/frontbook/home' target='_blank'><img
			...
			<div class="shopping-car fr">
				<div id="IncludeSmallCartDiv">
					<a class="car" href="javascript:void(0);">购物车</a>
				</div>
	...
	<div class="nav">
		<div class="contain">
			...
			<ul>
				...
				<li class="cur"><a
					href="<%=basePath%>/frontbook/ProductList?status=3&pageSize=10&pageNo=1"
					class="current">特惠图书</a></li>
				<li><a
...
(function() {
  ...
  s.parentNode.insertBefore(hm, s);
	...
	<div class="product contain">
		<div class="tt">
			<strong><a href="/">广购书城</a></strong> &gt; <a href=''>图书</a> &gt; <a
				href=''>小说</a> &gt; <font color=red>青春/网络</font> (876)
		</div>
		<div>
			<div class="leftNav">
				<div class="top">
					<div class="nt">
						<strong><font color=red>青春/网络</font></strong>
					</div>
					<div id="loadSort">
						<div class='list_lLoad'>
							<img src='' />
						</div>
						<ul class="fenlei-list">
							<li>·<a href="" class="">爱情/情感</a><span>(1485)</span></li>
							<li>·<a href="" class="">叛逆/成长</a><span>(369)</span></li>
							<li>·<a href="" class="">校园</a><span>(996)</span></li>
							<li>·<a href="" class="">娱乐/偶像</a><span>(276)</span></li>
							<li>·<a href="" class="">爆笑/无厘头</a><span>(154)</span></li>
							<li>·<a href="" class="">大陆原创</a><span>(1580)</span></li>
							<li>·<a href="" class="">港台青春文学</a><span>(50)</span></li>
							<li>·<a href="" class="">韩国青春文学</a><span>(134)</span></li>
							<li>·<a href="" class="">其他国外青春文学</a><span>(313)</span></li>
							<li>·<a href="" class="">玄幻/新武侠/魔幻</a><span>(944)</span></li>
							<li>·<a href="" class="">悬疑/惊悚</a><span>(231)</span></li>
				...
				<div class="top others-zp">
					<div class="nt">
						<strong>浏览过的历史</strong>
					</div>
					<dl>
						<dt>
							<a href="" target="_blank"><img src=""
								alt="水浒传(上下)(中国古典文学读本丛书)" /></a>
						</dt>
						<dd>
							<a href="" target="_blank" title="水浒传(上下)(中国古典文学读本丛书)">
								水浒传(上下)(中国古典文学读本丛书) </a>
							<div class="marketPrice">
								<span class="priceName">定价：</span><span class="priceValue">￥50.60</span>
							</div>
							<div class="memberPrice">
								<span class="priceName">广购价：</span><span class="priceValue">￥43.00</span>
							</div>
						</dd>
					</dl>
					<ul>
						<li><a href="" title="欢乐颂(典藏版)(全3册)">欢乐颂(典藏版)(全3册)</a></li>
						<li><a href="" title="西游记(上下)(经典名著大学名作)">西游记(上下)(经典名著大</a></li>
						<li><a href="" title="红楼梦(全2册)(经典名著大家名作)">红楼梦(全2册)(经典名著大</a></li>
						<li><a href="" title="百年孤独(精)">百年孤独(精)</a></li>
						<li><a href="" title="地球生命的历程">地球生命的历程</a></li>
						<li><a href="" title="我的世界--建筑指南(精)">我的世界--建筑指南(精)</a></li>
						<li><a href="" title=" 外婆的道歉信（已到货）"> 外婆的道歉信（已到货）</a></li>
						<li><a href="" title="围城(精)">围城(精)</a></li>
						<li><a href="" title="张爱玲全集(1)--倾城之恋">张爱玲全集(1)--倾城之恋</a></li>
					</ul>
				</div>
			</div>
			<div class="rightCon">
				<div class="orderBy">
					<div class="selectB">
						<input type="text" value="按销售量 降" /> <a href="javascript:void(0)"></a>
						<ul>
					...
					<ul class="fiveB">
						...
						<li class=" cur "><a id="sorting22" title="销量由高到底"
							class="down">销量</a></li>
					...
					<div class="checkboxB">
						<label> <input type="checkbox" checked
							onclick="javaScript:setUrlPara('page','1','NeedStock',this.checked?'true':'false');" />
							&nbsp;只显示有货
						</label>
					</div>
					<div class="lookWay">
						<span>显示方式</span> <a
							onclick="javaScript:setUrlPara('displayType','1');"><img
							src="" /></a> <a onclick="javaScript:setUrlPara('displayType','2');"><img
							src="" /></a>
					</div>
					<div class="pageB">
						<a onclick="javascript:void(0)" title="目前已是第一页" class="pre"></a> <span>第<i>1</i>页
						</span> <a class="nextpage" onclick="javaScript:setUrlPara('page','2');"
							title="下一页" class="next"></a>
					</div>
				</div>
					...
					<div id="search_list">
						<div class="proList">
							...
							<c:forEach var="book" items="${books}">
									<li>
										<div class="li-img fl">
											<a href="<%=basePath%>/frontbook/Product" target="_blank">
												<img id="imgbox_1351291"
												src="<%=basePath%>${book.bookCover}" alt="${book.bookName}"
												title="${book.bookName}" border="0" width="186" height="186" />
											</a>
										</div>
										<div class="li-con fl">
											<h2>
												<a href="<%=basePath%>/frontbook/Product"
													title="${book.bookName}" target="_blank"><strong>${book.bookName}</strong></a>
											</h2>
											<dl>
												<dt>
													<div class="line_1">
														<div class="memberPrice">
															<span class="priceName">特价：</span><span
																class="priceValue">${book.bookSellPrice}</span>
														</div>
													</div>
													<div class="line_2">
														<p>顾客评分</p>
														<p class="review_d">
															<span> <i></i><i></i><i></i><i></i><i></i>
															</span>
														</p>
														<p></p>
													</div>
													<div class="line_3">
														<span>作者： <em><a
																href="<%=basePath%>/frontbook/QueryByAuthor?Author=${book.bookAuthor}">
																	${book.bookAuthor}</a> </em>&nbsp; 著
														</span> <span>出版社：<em class="cut"
															title="${book.bookPress}"> <a
																href="<%=basePath%>/front/book/queryByPress?Press=${book.bookPress}">${book.bookPress}</a>
														</em>
														</span> <span>出版时间：<em>${book.bookPublishTime}</em></span>
													</div>
													<div class="line_4">《三十六大》里的文章都诚恳，大有用，可流传。出了这本书，冯唐也算青年导师了。杂文这东西，拼两点，一是见识，二是文笔。如果你情窦初开，读&ldquo;大欲&rdquo;，可以知道姑娘是用来做什么的；如果你受困于职场，读&ldquo;大行&rdquo;，学学麦肯锡式的生涯规划；如果你常常...</div>
												</dt>
												<dd>
													<a class="b_1" href="javascript:;"
														onclick="_gaq.push(['_trackEvent', 'click','购买键', '搜索页>放购物车']);isGoToCart(1351291)">加入购物车</a>
													<!-- <a href="javascript:void(0);" class="b_2"
														> 放入收藏夹 </a> -->
												</dd>
											</dl>
										</div>
							...
							<div id="showIncludeCart1351291"
										style="margin: -100px 0 0 420px; position: absolute;"></div>
								</ul>
						</div>
					</div>
			</div>
				...
				<div id="page_nav">
					<div id='infoPage'>
						<ul>
							...
							<li><a
								href='/ProductList.do?NeedStock=true&IsAsc=true&OrderBy=sales0-int&displayType=1&Cid=66287&pageSize=20&ppath=ZiwscHVzaHR5cGUwLCwvLCwxLCw7O2MsLGNpZCwsPGZvbnQgY29sb3I9cmVkPumdkuaYpS%2FnvZHnu5w8L2ZvbnQ%2BLCw2NjI4Nyws&charset=GBK&page=2'
								class='everyPage'>2</a></li>
							<li><a
								href='/ProductList.do?NeedStock=true&IsAsc=true&OrderBy=sales0-int&displayType=1&Cid=66287&pageSize=20&ppath=ZiwscHVzaHR5cGUwLCwvLCwxLCw7O2MsLGNpZCwsPGZvbnQgY29sb3I9cmVkPumdkuaYpS%2FnvZHnu5w8L2ZvbnQ%2BLCw2NjI4Nyws&charset=GBK&page=3'
								class='everyPage'>3</a></li>
							<li><a
								href='/ProductList.do?NeedStock=true&IsAsc=true&OrderBy=sales0-int&displayType=1&Cid=66287&pageSize=20&ppath=ZiwscHVzaHR5cGUwLCwvLCwxLCw7O2MsLGNpZCwsPGZvbnQgY29sb3I9cmVkPumdkuaYpS%2FnvZHnu5w8L2ZvbnQ%2BLCw2NjI4Nyws&charset=GBK&page=4'
								class='everyPage'>4</a></li>
							<li><a
								href='/ProductList.do?NeedStock=true&IsAsc=true&OrderBy=sales0-int&displayType=1&Cid=66287&pageSize=20&ppath=ZiwscHVzaHR5cGUwLCwvLCwxLCw7O2MsLGNpZCwsPGZvbnQgY29sb3I9cmVkPumdkuaYpS%2FnvZHnu5w8L2ZvbnQ%2BLCw2NjI4Nyws&charset=GBK&page=5'
								class='everyPage'>5</a></li>
							<li><a
								href='/ProductList.do?NeedStock=true&IsAsc=true&OrderBy=sales0-int&displayType=1&Cid=66287&pageSize=20&ppath=ZiwscHVzaHR5cGUwLCwvLCwxLCw7O2MsLGNpZCwsPGZvbnQgY29sb3I9cmVkPumdkuaYpS%2FnvZHnu5w8L2ZvbnQ%2BLCw2NjI4Nyws&charset=GBK&page=6'
								class='everyPage'>6</a></li>
							<li><a
								href='/ProductList.do?NeedStock=true&IsAsc=true&OrderBy=sales0-int&displayType=1&Cid=66287&pageSize=20&ppath=ZiwscHVzaHR5cGUwLCwvLCwxLCw7O2MsLGNpZCwsPGZvbnQgY29sb3I9cmVkPumdkuaYpS%2FnvZHnu5w8L2ZvbnQ%2BLCw2NjI4Nyws&charset=GBK&page=2'
								class='downPage' title='下一页'></a></li>
							<li>&nbsp;&nbsp;到第&nbsp;<input id='inputPage' value='1' />&nbsp;页
							</li>
							<li><a href='javascript:;'
								onclick="javascript:var goPage=this.parentNode.parentNode.getElementsByTagName('input')[0].value;if(isNaN(goPage)||goPage>44||goPage<1||goPage==1)return;document.location='/ProductList.do?NeedStock=true&IsAsc=true&OrderBy=sales0-int&displayType=1&Cid=66287&pageSize=20&ppath=ZiwscHVzaHR5cGUwLCwvLCwxLCw7O2MsLGNpZCwsPGZvbnQgY29sb3I9cmVkPumdkuaYpS%2FnvZHnu5w8L2ZvbnQ%2BLCw2NjI4Nyws&charset=GBK&page='+goPage;return false;"
								class='goToPage'></a></li>
						</ul>
					</div>
				</div>
	...
	<div id="footer">
		...
		<div id="myfooter" style="text-align: center;">
			...
			<!--诚信电商logo 结束-->
			<img src="<%=basePath%>/img/footer_img.gif" alt="" /> &nbsp;&nbsp; <a
				rel="nofollow"
