...
<div class="box">
<div class="box1">
<h1><a class="" href="/Info/HelpList.do?jid=9502&cid=9502&mid=0">最新公告</a></h1>
<ul>
</ul>
</div>
<div class="box2">
<h1><a class="" href="/Info/HelpList.do?jid=9504&cid=9504&mid=0">图书最新报道</a></h1>
<ul>
</ul>
</div>
</div>
...
<div class="top"></div>
<div class="box">
<h2><div style="font-size: 18px">${advertise.adTitle }</div> </h2>
<div style="width:730px; line-height:18px;overflow:hidden;margin:0 20px;">${advertise.adContent }</div>
</div>
<div class="bottom"></div>
</div>
<div class="clear"></div>
