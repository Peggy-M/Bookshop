...
<link href="<%=basePath%>/css/showInfo.css" rel="stylesheet" type="text/css"/>
...
<h1>
<a href='<%=basePath%>/frontbook/home'><img src='<%=basePath %>/img/20161208022939348.jpg' width='200' height='30' alt='广购书城' border='0'/></a>
...
<div class="search">
<link type="text/css" rel="StyleSheet" media="all" href="/js/suggest/jquery.suggest.css"/>
<script type="text/javascript" language="javascript" src="/js/jquery/jquery.dimensions.min.js"></script>
<script type="text/javascript" language="javascript" src="/js/suggest/jquery.suggest.js"></script>
<!-- 关键字搜索 -->
...
<a href="<%=basePath%>/frontbook/home">首页</a></li>
  ...
  <li class="cur"><a href="<%=basePath%>/frontadvertise/adlist"" class="current">商城公告</a></li>
</ul>
...
<!--end 页头-->
    ...
    <!-- <div id="head_position">您现在的位置：<a href="/">首页</a> &gt; 信息公告 &gt;最新公告</div> -->
    <div id="help">
		<div class="top">
        	<span><a href="/">广购书城</a> </span>
        	<a href="#">&gt; 信息公告 &gt;最新公告</a>
        </div>
           ...
           <h1>最新公告</h1>
			...
			<ul class="list">
				<c:forEach items="${advertiseList }" var="advertise">
                 	<li><a href="<%=basePath %>/frontadvertise/adshow?id=${advertise.adId }" title="${advertise.adTitle }">${advertise.adTitle }</a></li>
                </c:forEach>
			</ul>
		<div class="showInfo_page" style="height:25px;">
			<div style="float:right">
				<div id='infoPage'>
					<ul>
						...
						<!-- 显示分页 -->
						<li>&nbsp;&nbsp;到第&nbsp;
							<select name='select2' onchange="window.location.href='/Info/AllInfoList.do?count=20&cid=9502&page='+this.options[this.selectedIndex].value + ''">
