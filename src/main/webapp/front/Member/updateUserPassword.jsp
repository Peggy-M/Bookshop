...
<div class="memRight">
     <h1 class="memRightTitle">
      ...
      <div class="edique_title">登录密码修改</div>
	  <form id="updatePassForm" style="margin:0px;" onsubmit="return false;">
		  <div class="edique_m1">
		    <div class="edique_tips" style="display:none; color:#c00;" id="showMsg"></div>
		    <div class="edique_ml">* 旧&nbsp;&nbsp;密&nbsp;&nbsp;码：</div>
		    <div class="edique_mr"><input type="password" id="passwordOld"/></div>
		    <div class="edique_ml">* 新&nbsp;&nbsp;密&nbsp;&nbsp;码：</div>
		    <div class="edique_mr"><input type="password" id="newpassword" /></div>
		    <div class="edique_ml">* 确定新密码：</div>
		    <div class="edique_mr"><input type="password" id="ConfirmPassword" /></div>
	
			<div class="clear"></div>
			
			<div class="edique_btn">
			  <img src="<%=basePath %>/img/mem_btnSave.gif" onclick="checkPassForm()"/>
			  </div>
	      </div>
      </form>
	...
	<script type="text/javascript">
		...
		function checkPassForm() {
			var passwordOld = $('#passwordOld').val();	//旧密码
			var newpassword = $('#newpassword').val();	//新密码
			var ConfirmPassword = $('#ConfirmPassword').val();	//确认新密码
			if (passwordOld==''||newpassword==''||ConfirmPassword=='') {
				alert('请输入密码');
			}else {
				if (newpassword==ConfirmPassword) {
					var url = '<%=basePath%>/Member/updatePassword.do';
					$.post(
						url,
						{
