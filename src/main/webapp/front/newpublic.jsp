...
<dt><a href="#">全部图书分类</a></dt>
		...
		<ul>
		  ...
		  <li class="cur"><a class="current" href="<%=basePath%>/frontadvertise/adlist"">商城公告</a></li>
		</ul>
      ...
      <div class="right">
        ...
        <div class="box">
           ...
           <div style="width:730px; line-height:18px;overflow:hidden;margin:0 20px;">
                      ...
                      &nbsp;自6月10日起--7月10日，在广购网注册会员，即可享受赠送50元优惠券的活动。
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;活动规则：1、登录www.gg1994.com或扫描首页海报中的二维码，进入注册。</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;2、注册成功后，系统自动绑定到账户，7月1号开始使用，有效期为一个月。</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</p>
