  ...
  <body>
	<div class="container">
		  <div class="form-group">
		    ...
		    <input type="text" id="addressName" class="form-control" id="exampleInputEmail1" value="${address.addressUserName }">
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <input type="text" id="addressDetail" class="form-control" id="exampleInputEmail1" value="${address.addressDetails }">
		  </div>
		  <div class="form-group">
		    <label for="exampleInputEmail1">手机号码：</label>
		    <input type="text" id="phoneNumber" class="form-control" id="exampleInputEmail1" value="${address.addressPhone }">
		  </div>
		  <div class="form-group">
		    <label for="exampleInputEmail1">邮政编码：</label>
		    <input type="text" id="postalcode" class="form-control" id="exampleInputEmail1" value="${address.addressPostcode }">
		  </div>
		  <button id="submit" type="button" class="btn btn-primary btn-lg btn-block">修改</button>
	</div>
    ...
    <script type="text/javascript">
    	$('#submit').click(function() {
    		...
    		if (result==true) {
    			...
    			var url = '<%=basePath%>/Member/updateAddress.do';
